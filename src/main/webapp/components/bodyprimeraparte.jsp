...
<body id="page-top">
    ...
    <!-- Validación Sesión, si no es valida no abrira niguna pagina de la aplicacion -->
    <% HttpSession misession = request.getSession();
            //valido que la sesion exista
            ...
            <li class="nav-item">
                ...
                <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="SvVerTurnos">Ver Turnos de Pacientes</a>
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                                ...
                                <!-- muestra el usuario que inicio sesion con el codigo java -->
